...
interface CourseRepository {
    ...
    suspend fun getCourseById(courseId: Int): Either<CourseError, Course>

    suspend fun getProgress(courseId: Int): Either<CourseError, CourseScore>

    suspend fun getCourseDeadlines(courseId: Int): Either<CourseError, List<DeadlineCourse>>
}