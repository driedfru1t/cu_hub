...
) : com.nikol.lms.data.remote.model.material.LongreadMaterialItemDto
...
data class LongreadExerciseQuestionsMaterialItemDto(
    ...
    @SerialName("questions") val questions: List<com.nikol.lms.data.remote.model.question.LongreadExerciseQuestionItemDto>
) : LongreadMaterialItemDto
